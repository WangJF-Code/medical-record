 ...
 * @Version 1.0
 */
@Api(tags = "辅助检查-多单选类检查项相关接口")
@RestController
@RequestMapping("/api/detectItem/multipleSingle")
public class DetectItemMultipleSingleController {
    ...
    @ApiOperation("详细信息")
    @GetMapping("/{id}")
    public ApiResult<DetectItemMultipleSingleDTO> info(@ApiParam(required = true, value = "id") @PathVariable Integer id) {
        DetectItemMultipleSingleDTO info = service.getMultipleSingle(id);
