 ...
 * @Version 1.0
 */
@Api(tags = "辅助检查-单选类检查项相关接口")
@RestController
@RequestMapping("/api/detectItem/single")
public class DetectItemSingleController {
    ...
    @ApiOperation("详细信息")
    @GetMapping("/{id}")
    public ApiResult<DetectItemSingleDTO> info(@ApiParam(required = true, value = "id") @PathVariable Integer id) {
        DetectItemSingleDTO info = service.getSingle(id);
